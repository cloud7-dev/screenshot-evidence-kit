...
function printUsage() {
  console.error("Usage:");
  console.error("  node scripts/veripacket-verify.mjs digest <manifest.json>");
  console.error("  node scripts/veripacket-verify.mjs verify <manifest.json>");
  console.error("  node scripts/veripacket-verify.mjs verify <packet-folder>");
  console.error("  node scripts/veripacket-verify.mjs verify <evidence-packet.zip>");
}
